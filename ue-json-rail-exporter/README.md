...
- Writes JSON to `web-maze-builder/exported_level_rails.json` by default.
...
```python
exec(open(r"/Users/ddonlien/Documents/GitHub/ball-maze-tools/ue-json-rail-exporter/export_level_rails_to_json.py", encoding="utf-8").read())
```
