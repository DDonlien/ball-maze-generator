...
`web-maze-builder/rail_config.csv` exists in the expected Content Browser
location.
...
```python
exec(open(r"C:\path\to\ball-maze-tools\ue-rail-content-checker\check_rail_content.py", encoding="utf-8").read())
```
